...
function HeroIllustration() {
  ...
  return (
    <AnimateOnScroll animation="fade-right" delay={300} duration={900} immediate>
          ...
          <div className="mb-5 flex flex-wrap items-center justify-center gap-2 sm:gap-2.5">
            {topBadges.map((label, index) => (
              <AnimateOnScroll
                ...
                immediate
              >
                <span className="rounded-full border border-border bg-white px-3.5 py-1.5 text-xs font-semibold text-navy shadow-sm">
                  {label}
                </span>
              </AnimateOnScroll>
            ))}
      ...
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
        <div className="grid items-center gap-12 lg:grid-cols-2">
          <div>
            ...
            <AnimateOnScroll animation="fade-up" delay={100} immediate>
            ...
            <AnimateOnScroll animation="fade-up" delay={200} immediate>
            ...
            <AnimateOnScroll animation="fade-up" delay={350} immediate>
              <div className="mt-8 flex flex-col gap-4 sm:flex-row">
                <a
                  href="#contact"
                  className="inline-flex items-center justify-center gap-2 rounded-lg bg-primary px-6 py-3.5 text-sm font-semibold text-white transition-all hover:bg-primary-dark hover:shadow-lg hover:shadow-primary/25"
                >
                  <svg
                    className="h-4 w-4"
                    fill="none"
                ...
                <a
                  href="#contact"
                  className="inline-flex items-center justify-center gap-2 rounded-lg border-2 border-border bg-white px-6 py-3.5 text-sm font-semibold text-navy transition-all hover:border-primary hover:text-primary hover:shadow-md"
                >
                  <svg
                    className="h-4 w-4"
                    fill="none"
            ...
            <div className="relative overflow-hidden">
              <div className="flex animate-marquee whitespace-nowrap">
                {[...partners, ...partners].map((partner, index) => (
                  <span
                    key={`${partner}-${index}`}
                    className="mx-8 inline-block text-sm font-semibold text-slate/70 transition-colors hover:text-navy"
                  >
                    {partner}
                  </span>
                ))}
