...
import AdminActivitySettingsCard from '@/components/admin/settings/AdminActivitySettingsCard';
import { systemSettingsBasePath } from '@/lib/admin/systemSettingsNavigation';

export default function AdminActivitySettingsPage() {
  return (
    <div className="flex flex-col gap-8 px-4 pb-12 pt-6 sm:px-6 lg:px-8 lg:pt-8">
      <header className="flex flex-col gap-5">
        ...
        <div className="min-w-[280px]">
          ...
          <p className="text-base font-normal leading-6 text-[#475467]">Track Admin Activity.</p>
        </div>
      </header>

      <AdminActivitySettingsCard />
    </div>
  );
}
