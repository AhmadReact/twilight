...
import QuestionnaireControlCard from '@/components/admin/platform-control/QuestionnaireControlCard';
      ...
      <header className="flex flex-col gap-5">
        ...
        <div className="min-w-[280px]">
          ...
          <p className="text-base font-normal leading-6 text-[#475467]">
            Control Questionnaire and its fields.
          </p>
        </div>
      </header>

      <QuestionnaireControlCard />
    </div>
  );
}
